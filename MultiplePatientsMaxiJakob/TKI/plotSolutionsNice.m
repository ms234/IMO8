function plotSolutionsNice(SOL,Npatients,tmax1,T0,E0,S0,toff,tmax3)
...
plot([toff(1) toff(1)],[0 yy(2)],'-','Color',[0.5 0.5 0.5],'LineWidth',1.5);
plot([toff(2) toff(2)],[0 yy(2)],'-','Color',[0.5 0.5 0.5],'LineWidth',1.5);
plot([tmax3 tmax3],[0 yy(2)],'k-','LineWidth',1.5);
title(titles{ccc});
xlabel('time (d)');
